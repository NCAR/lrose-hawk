...
DBZ_F DBZ_F   mdvp:://localhost::mdv/radarPolar/cp2_s&DBZ_F   	dbz.colors     dBZ    -5   80  5  cart   1 0
DBZ 	DBZ     mdvp:://localhost::mdv/radarPolar/cp2_s&DBZ   	dbz.colors     dBZ    -5   80  5  cart   1 0
#DBZ_x 	DBZ_x     mdvp:://localhost::mdv/radarPolar/cp2_x&DBZ   	dbz.colors     dBZ    -5   80  5  cart   1 0

VEL_F VEL_F   mdvp:://localhost::mdv/radarPolar/cp2_s&VEL_F   	vel.colors    m/s     -5   80  5  cart   1 0
VEL 	VEL     mdvp:://localhost::mdv/radarPolar/cp2_s&VEL   	vel.colors    m/s     -5   80  5  cart   1 0

WIDTH_F WIDTH_F mdvp:://localhost::mdv/radarPolar/cp2_s&WIDTH_F  	width.colors  m/s     -5   80  5  radial   1 0
WIDTH WIDTH     mdvp:://localhost::mdv/radarPolar/cp2_s&WIDTH     	width.colors  m/s     -5   80  5  radial   1 0

CLUT	CLUT      mdvp:://localhost::mdv/radarPolar/cp2_s&CLUT   	dbz.colors    dB      -5   80  5  radial   1 0

#LDRH_x  LDRH_x      mdvp:://localhost::mdv/radarPolar/cp2_x&LDRH  	ldr.colors   dB      -5   80  5  radial   1 0
#LDRV_x  LDRV_x      mdvp:://localhost::mdv/radarPolar/cp2_x&LDRV  	ldr.colors   dB      -5   80  5  radial   1 0

PHIDP_F PHIDP_F mdvp:://localhost::mdv/radarPolar/cp2_s&PHIDP_F  	phidp.colors  deg     -5   80  5  radial   1 0
PHIDP PHIDP     mdvp:://localhost::mdv/radarPolar/cp2_s&PHIDP  	phidp.colors  deg     -5   80  5  radial   1 0

RHOHV	RHOHV     mdvp:://localhost::mdv/radarPolar/cp2_s&RHOHV  	rhohv.colors   _     -5   80  5  radial   1 0

KDP   KDP       mdvp:://localhost::mdv/radarPolar/cp2_s&KDP         	kdp.colors   deg/km  -5   80  5  radial   1 0

#NCP 	NCP       mdvp:://localhost::mdv/radarPolar/cp2_s&NCP    	fraction.colors  dB   -5   80  5  radial   1 0

ZDR	ZDR       mdvp:://localhost::mdv/radarPolar/cp2_s&ZDR  	zdr.colors 	dB      -5   80  5  radial   1 0
#ZDRM	ZDRM      mdvp:://localhost::mdv/radarPolar/cp2_s&ZDRM  	zdr.colors 	dB      -5   80  5  radial   1 0

CPA CPA mdvp:://localhost::mdv/radarPolar/cp2_s&CPA  fraction.colors  -     -5   80  5  radial   1 0

TDBZ   TDBZ       mdvp:://localhost::mdv/radarPolar/cp2_s&TDBZ    tdbz.colors  dBZSq     -5   80  5  radial   1 0

SPIN   SPIN       mdvp:://localhost::mdv/radarPolar/cp2_s&SPIN    percent.colors  %     -5   80  5  radial   1 0

ZDR_SDEV  ZDR_SDEV  mdvp:://localhost::mdv/radarPolar/cp2_s&ZDR_SDEV   sdzdr.colors    dB     -5   80  5  radial   1 0

PHIDP_SDEV  PHIDP_SDEV mdvp:://localhost::mdv/radarPolar/cp2_s&PHIDP_SDEV  sdphidp.colors  -     -5   80  5  radial   1 0

CMD        CMD        mdvp:://localhost::mdv/radarPolar/cp2_s&CMD     cmd.colors  none     -5   80  5  radial   1 0
CMD_FLAG   CMD_FLAG    mdvp:://localhost::mdv/radarPolar/cp2_s&CMD_FLAG cmd_flag.colors  none     -5   80  5  radial   1 0

SNR 	SNR        	mdvp:://localhost::mdv/radarPolar/cp2_s&SNR    	snr.colors    dB      -5   80  5  radial   1 0
SNR_x 	SNR_x        	mdvp:://localhost::mdv/radarPolar/cp2_x&SNR    	snr.colors    dB      -5   80  5  radial   1 0
#DBM	DBM        	mdvp:://localhost::mdv/radarPolar/cp2_s&DBM    	dbm.colors    dB      -5   80  5  radial   1 0
#DBM	DBM_x        	mdvp:://localhost::mdv/radarPolar/cp2_x&DBM    	dbm.colors    dB      -5   80  5  radial   1 0

SNRHC_s SNRHC_s mdvp:://localhost::mdv/radarPolar/cp2_s&SNRHC  snr.colors    dB      -5   80  5  radial   1 0
SNRVC_s SNRVC_s mdvp:://localhost::mdv/radarPolar/cp2_s&SNRVC  snr.colors    dB      -5   80  5  radial   1 0

AIQ  AIQ  mdvp:://localhost::mdv/radarPolar/cp2_s&AIQ  angle.colors  deg    -5   80  5  radial   1 0
NIQ  NIQ  mdvp:://localhost::mdv/radarPolar/cp2_s&NIQ  dbm.colors    dB     -5   80  5  radial   1 0

Terrain  Terrain  mdvp::static//localhost::mdv/terrain&Elevation  terrain.colors   m   -5   80  5  dcont   1 0

DBZ_merged  DBZ_merged  mdvp:://localhost::mdv/radarCart/BrisMerge&DBZ  dbz.colors   dBZ     -5   80  5  dcont   1 0
DBZ_composite  DBZ_composite  mdvp:://localhost::mdv/radarCart/BrisMerge&DBZ  dbz.colors   dBZ     -5   80  5  dcont,comp   1 0
DBZ_MtStapl DBZ_MtStapl  mdvp:://localhost::mdv/radarCart/MtStapl&DBZ  dbz.colors   dBZ     -5   80  5  dcont   1 0
DBZ_Marburg DBZ_Marburg  mdvp:://localhost::mdv/radarCart/Marburg&DBZ  dbz.colors   dBZ     -5   80  5  dcont   1 0
DBZ_Kanign DBZ_Kanign  mdvp:://localhost::mdv/radarCart/Kanign&DBZ  dbz.colors   dBZ     -5   80  5  dcont   1 0
DBZ_Grafton DBZ_Grafton  mdvp:://localhost::mdv/radarCart/Grafton&DBZ  dbz.colors   dBZ     -5   80  5  dcont   1 0
DBZ_Moree DBZ_Moree  mdvp:://localhost::mdv/radarCart/Moree&DBZ  dbz.colors   dBZ     -5   80  5  dcont   1 0
VIL_merged  VIL_merged  mdvp:://localhost::mdv/vil/BrisMerge&vil  vil_color_bom   kg/m2   -5   80  5  dcont   1 0
DVIL_merged DVIL_merged mdvp:://localhost::mdv/vil/BrisMerge&dVil vil_color_bom   kg/m2   -5   80  5  cart   1 0
SSS_merged  SSS_merged  mdvp:://localhost::mdv/vil/BrisMerge&SSS  sss_color.1     svrty   -5   80  5  cart   1 0
...
#----------------------------------------------------------------------------
#TREC    mdvp:://localhost::dia/mdv/ctrec/ftg&  #1 #2 None  m/s  2      yellow
...
AusCoast   AusCoast AusCoast.map   1  0.0 10000.0     white
radars     radars   radars.map     1  0.0 10000.0     green
CP2MtStaplDualDoppler30 CP2MtStaplDualDoppler30 CP2MtStaplDualDoppler30.map 1  0.0 10000.0     cyan
CP2MtStaplDualDoppler45 CP2MtStaplDualDoppler45 CP2MtStaplDualDoppler45.map 1  0.0 10000.0     yellow
</MAPS>
...
# temporal rounding. 
#cidd.demo_time: 17:00 10/28/2007
#cidd.demo_time: 03:50 11/16/2007
cidd.demo_time: 18:50 12/10/2007
...
cidd.level2_min_xkm:            -100.0
cidd.level2_min_ykm:            -100.0
cidd.level2_max_xkm:             100.0
cidd.level2_max_ykm:             100.0
#
...
#
cidd.menu_bar_label7: Value 
cidd.menu_bar_funct7: REPORT_MODE_ONOFF
#  
...
cidd.horiz_frame_label:  **  BOM CP2 **
...
prod_info = {
  {
    menu_label = "Tstorms" ,
    url = "spdbp:Tstorms2Symprod://localhost::spdb/tstorms/BrisMerge",
    data_type = 0,
  ...
  {
    menu_label = "Ltg" ,
    url = "spdbp:Ltg2Symprod://localhost::spdb/ltg",
    data_type = 0,
  ...
  ,
  {
    ...
    url = "spdbp:Metar2Symprod:simple//localhost::spdb/aws",
    data_type = 0,
    render_type = RENDER_LATEST_IN_FRAME,
    on_by_default = FALSE,
  ...
  ,
  {
    ...
    url = "spdbp:Metar2Symprod:labels//localhost::spdb/aws",
    data_type = 0,
    render_type = RENDER_LATEST_IN_FRAME,
    on_by_default = FALSE,
    minutes_allow_before = 70.0,
