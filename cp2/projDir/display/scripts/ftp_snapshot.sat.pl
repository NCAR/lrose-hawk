...
#$targetdir = "incoming/irap/Queensland/images/sat/${day_str}"; # The remote target data directory.
...
if ($file_name =~ /VIS/) {
  $targetdir = "SatQuickImages/VIS/${day_str}";
 } elsif ($file_name =~ /IR/) {
  $targetdir = "SatQuickImages/IR/${day_str}";
} elsif ($file_name =~ /WV/) {
  $targetdir = "SatQuickImages/WV/${day_str}";
} else {
  $targetdir = "SatQuickImages/misc/${day_str}";
}
