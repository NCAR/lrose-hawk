...
input_dir = "/home/dixon/data/bom/cp2/mdv/radarPolar/cp2_s/sur";
...
pid_thresholds_file_path = "$(PROJ_DIR)/titan/params/pid_thresholds.sband.gap";
...
sounding_spdb_url = "/home/dixon/data/bom/cp2/spdb/soundings";
...
output_fields = {
  ...
  ,
  {
    id = PARTICLE_ID2,
    name = "PID2",
    long_name = "particle_id2",
    standard_name = "hydrometeor_type2",
    units = "",
    encoding = OUTPUT_ENCODING_INT16,
    scaling = OUTPUT_SCALING_SPECIFIED,
    scale = 1,
  ...
  ,
  {
    id = PID_INTEREST,
    name = "PID_INTEREST",
    long_name = "particle_id_interest",
    standard_name = "interest_for_primary_pid",
    units = "",
    encoding = OUTPUT_ENCODING_INT16,
    scaling = OUTPUT_SCALING_DYNAMIC,
    scale = 1,
  ...
  ,
  {
    id = PID_INTEREST2,
    name = "PID_INTEREST2",
    long_name = "particle_id_interest2",
    standard_name = "interest_for_secondary_pid",
    units = "",
    encoding = OUTPUT_ENCODING_INT16,
    scaling = OUTPUT_SCALING_DYNAMIC,
    scale = 1,
  ...
  ,
  {
    id = SDZDR_FOR_PID,
    name = "SDZDR_FOR_PID",
    long_name = "sdev_of_zdr_used_for_pid",
    standard_name = "",
    units = "dB",
    encoding = OUTPUT_ENCODING_INT16,
    scaling = OUTPUT_SCALING_DYNAMIC,
  ...
  ,
  {
    ...
    long_name = "sdev_of_phidp_used_for_pid",
    standard_name = "",
    units = "deg",
    encoding = OUTPUT_ENCODING_INT16,
    scaling = OUTPUT_SCALING_DYNAMIC,
...
output_dir = "$(HOME)/data/bom/cp2/cfradial/partrain";
