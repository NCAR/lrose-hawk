...
if(($stat_ret = stat("_latest_data_info")) == FALSE) {
 ...
 // Check to see if file is older than 12 minutes (720 secs)
 if($stat_ret[8] < (time() - 720)) $error_cond = TRUE;
...
<HTML>
 <HEAD>
    <meta HTTP-EQUIV="Pragma" CONTENT="no-cache">
    <!-- refresh (forward) to this file after 60 seconds -->
    <meta http-equiv="refresh" content="60;URL=_index.php">
 </HEAD>
