...
#===========================================================================
#
# Put Matlab analysis images to catalog
#
#===========================================================================
...
def main():
    ...
    beginString = "BEGIN: putMatlabAnalysisToCatalog.py"
    ...
    fullFilePath = os.path.join(options.imageDir, options.fileName);
    ...
    fieldName = ""
    if (options.fileName.find("PID_RHI_summary") >= 0):
        fieldName = "PID_RHI_daily_summary"
    elif (options.fileName.find("PID_RHI_diurnal") >= 0):
        fieldName = "PID_RHI_diurnal_trend"
    else:
        sys.exit(0) # not needed

    catalogName = "research.SPOL_PID." + validTimeStr + "." + fieldName + ".png"
    ...
    if (options.debug == True):
        print >>sys.stderr, "==================================================="
        print >>sys.stderr, \
              "END: putMatlabAnalysisToCatalog.py" \
