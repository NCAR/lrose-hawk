...
#===========================================================================
#
# Download Catalog data using sftp
#
#===========================================================================
...
def main():
    ...
    beginString = "BEGIN: getCatalogFilesBySFtp.py"
    ...
    subDirList = sftp.listdir()

    # get files for each dir

    for dirName in subDirList:
        dirPath = os.path.join(options.sourceDir, dirName)
        getFilesFromDir(sftp, dirName, dirPath)
    ...
    print "=========================================================="
    print "END: getCatalogFilesByFtp.py at " + str(datetime.datetime.now())
    print "=========================================================="
...
def getFilesFromDir(sftp, dirName, dirPath):
        ...
        if (doGet):
            ...
            if ((fileAlreadyHere == False) or (options.force == True)):
                ...
                cmd = "LdataWriter -dir " + options.targetDir \
                      ...
                      + " -writer getCatalogFilesByFtp.py" \
...
def parseArgs():
    ...
    defaultTargetDir = os.getenv("DATA_DIR") + "/raw/catalog/gts_sounding"
    defaultTmpDir = os.getenv("DATA_DIR") + "/tmp/raw/catalog/gts_sounding"
    ...
    parser.add_option('--sourceDir',
                      dest='sourceDir',
                      default='/var/www/html/dynamo/data/gts_sounding',
