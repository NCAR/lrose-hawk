...
def main():
    ...
    beginString = "BEGIN: getLtgDataByHttp.py"
    ...
    for line in lines:
        ...
        nameLoc = line.find(".dynamo.loc")
        if (nameLoc > 0):
            nameStart = nameLoc - 13;
            fileName = line[nameStart:nameStart + 24]
    ...
    print "=========================================================================="
    print "END: getLtgDataByHttp.py at " + str(datetime.datetime.now())
    print "=========================================================================="
...
def parseArgs():
    ...
    defaultTargetDir = os.getenv("DATA_DIR") + "/raw/wwlln"
