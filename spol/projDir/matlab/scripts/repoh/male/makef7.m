...
figure(7)
pcolor(0:6:(numfiles-124-120-1)*6,0:0.1:(maxheight-0.1),azresid(:,245:end)), shading interp, colormap(flipud(baroclinic)), caxis([-10 10])
...
title('Male soundings:  Zonal wind anomalies','FontSize',16);
