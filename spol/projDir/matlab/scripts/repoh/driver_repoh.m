...
%Comment out one of the 'dates' lines!
  ...
  dates = {'20111019'};  %Enter 1 for yesterday; otherwise yyyymmdd inside ' '.

  %To view files across more than one day (perhaps across 00Z) enter ['date1','date2'] in yyyymmdd.
  %dates = [{'20111012'},{'20111013'},{'20111014'},{'20111015'},{'20111016'},{'20111017'},{'20111018'},{'20111019'},{'20111020'},{'20111021'}];
...
sounding_dir = '/home/operator/projDir/data/matlab/sounding/matfiles/';  %Where are the sounding matfiles?
repoh_dir = '/home/operator/projDir/data/matlab/REPoH/';         %Where are the REPoH matfiles?  Dates should be subdirectories within.
