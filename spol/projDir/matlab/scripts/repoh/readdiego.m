...
%Author:  S. Powell, UW
%Description:  Read in Diego Garcia soundings and plot data.

clear all; close all; clc;
Rstar = 287;
maxheight = 20;

system('ls -C1 ~/spowell/humidity_retrieval/diego/data/*.nc > out');
filenames = [];
fid = fopen('out');
[A,B] = system('wc -l out');
...
amwind = nan(300,numfiles); azwind = nan(300,numfiles); atemp = nan(300,numfiles);
...
%iss3_sounding.D20111016_120000.nc
%iss3_sounding.D20111016_150000.nc
%iss3_sounding.D20111016_180000.nc
%iss3_sounding.D20111016_210000.nc
%iss3_sounding.D20111017_000000.nc
%iss3_sounding.D20111017_030000.nc
%iss3_sounding.D20111020_180000.nc
%iss3_sounding.D20111020_210000.nc
%iss3_sounding.D20111021_000000.nc
%iss3_sounding.D20111021_030000.nc
%iss3_sounding.D20111021_060000.nc
%iss3_sounding.D20111021_090000.nc
%iss3_sounding.D20111021_120000.nc
%iss3_sounding.D20111025_180000.nc
%iss3_sounding.D20111025_210000.nc
%iss3_sounding.D20111026_000000.nc
%iss3_sounding.D20111026_030000.nc
%iss3_sounding.D20111026_060000.nc
%iss3_sounding.D20111026_090000.nc
%iss3_sounding.D20111026_120000.nc
%iss3_sounding.D20111026_150000.nc
%iss3_sounding.D20111026_180000.nc
...
for j = 1:size(filenames,2)
  ...
  if length(cell2mat(filenames(j))) ~= 90  %Bad file
    P(~isnan(P)) = NaN;
    T(~isnan(T)) = NaN;
    Td(~isnan(Td)) = NaN;
    rh(~isnan(rh)) = NaN;
  ...
  for k = 1:numel(unique(rhgt))
    ...
    amwind(k,j) = nanmean(u(rhgt == ihgt(k,j)));
    azwind(k,j) = nanmean(v(rhgt == ihgt(k,j)));
...
save('~/spowell/humidity_retrieval/diego/retarded.mat')
