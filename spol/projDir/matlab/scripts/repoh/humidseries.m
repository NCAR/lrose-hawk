function humidseries(sounding_dir)
...
system('ls -C1 ~/projDir/data/matlab/gan/matfiles/201*.mat > files.humidseries');
[A,B] = system('wc -l files.humidseries');
...
system('rm -f files.humidseries');

save('~/projDir/data/matlab/sounding/matfiles/retarded.mat');
