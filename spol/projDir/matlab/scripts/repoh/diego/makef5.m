...
timestamp = '000000';
 ...
 figure(5)
pcolor(0:3:(numfiles-248-1)*3,0:0.1:(maxheight-0.1),amresid(:,249:end)), shading interp, colormap(flipud(baroclinic)), caxis([-10 10])
...
title('Diego Garcia soundings:  Meridional wind anomalies','FontSize',16);
