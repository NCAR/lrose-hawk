...
figure(4)
pcolor(0:3:(numfiles-248-1)*3,0:0.1:(maxheight-0.1),amwind(:,249:end)), shading interp, colormap(flipud(baroclinic)), caxis([-20 20])
...
title('Diego Garcia soundings:  Meridional wind','FontSize',16);
