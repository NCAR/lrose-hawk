...
timestamp = '000000';
 ...
 figure(3)
pcolor(0:3:(numfiles-248-1)*3,0:0.1:(maxheight-0.1),frdiff(:,249:end)), shading interp, colormap(flipud(baroclinic)), caxis([-200 200])
...
title('Diego Garcia soundings:  Vapor density deviation','FontSize',16);
