...
figure(2)
pcolor(0:3:(numfiles-237-1)*3,0:0.1:(maxheight-0.1),double(arh(:,238:end))), shading interp, caxis([0 100]), colorbar;
...
title('Revelle Soundings:  Relative Humidity','FontSize',16);
%print -djpeg rh.jpg
